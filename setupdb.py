...
new_assignment = Assignments('Introduction to Physics' , 8 , 'expert' , 5 , 0 , 1 , 1)
db.session.add(new_assignment)

new_assignment = Assignments('Electrochemistry' , 9 , 'expert' , 5 , 0 , 1 , 2)
db.session.add(new_assignment)

new_assignment = Assignments('Organic Chemistry' , 9 , 'expert' , 5 , 0 , 1 , 2)
db.session.add(new_assignment)

new_assignment = Assignments('Past,Present and Future Tense' , 11 , 'expert' , 5 , 0 , 1 , 3)
db.session.add(new_assignment)

new_assignment = Assignments('Test your Algebra Concepts' , 10 , 'expert' , 5 , 0 , 1 , 3)
db.session.add(new_assignment)

new_assignment = Assignments('OpenMP and MPI ' , 4 , 'expert' , 5 , 0 , 1 , 3)
db.session.add(new_assignment)

new_assignment = Assignments('Three Schema Architecture' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Normalization Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Serialization Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Transaction Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Key Constraints Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Integrity Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete MySql Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete MondoDB Practice' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('Introduction to ERD' , 1 , 'expert' , 5 , 0 , 1 , 4)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Flask Practice' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('How to Nodejs' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('How to PHP' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('PHP and MySql' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('PHP and MongoDb' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('Intoduction to React' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('Scrapping using Scrappy' , 13 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete Html5 Practice' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)

new_assignment = Assignments('The Complete CSS Practice' , 12 , 'expert' , 5 , 0 , 1 , 5)
db.session.add(new_assignment)
